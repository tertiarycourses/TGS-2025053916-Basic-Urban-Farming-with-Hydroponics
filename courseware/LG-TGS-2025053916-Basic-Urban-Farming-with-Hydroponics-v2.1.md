...
1. Trace one water path from reservoir to delivery, root zone and return without touching equipment.
...
1. Compare crop condition at inlet, middle and return positions and across tiers where present.
...
1. Record how pH, EC, temperature and level/flow are measured and corrected.
...
1. Inspect WSH, food safety, pest monitoring, housekeeping and maintenance evidence.
...
1. Review the checklist with a peer, resolve unclear statements and submit the PDF evidence set.
...
1. Read the kit SOP; identify pump, reservoir, channel, tubing, return, planting sites and electrical isolation.
...
1. Inspect for cleanliness, stability, cable damage, tubing kinks and safe separation of water and power.
...
1. Assemble only as shown in the SOP, fill with source water, keep electrical connectors dry and check for leaks before energising.
...
1. Energise the pump and confirm delivery to every planting site, unobstructed return and adequate reservoir freeboard.
...
1. Measure and record source-water pH, EC and temperature using calibrated meters.
...
1. Add the trainer-specified Part A dose to water, circulate, then add Part B and circulate; never mix concentrates directly.
...
1. Measure EC; make only small trainer-approved corrections with circulation between additions.
...
1. Measure pH; if adjustment is authorised, use the labelled product, PPE and dedicated dosing tool, then circulate and remeasure.
...
1. Place an accepted seedling so its plug is supported, roots meet moisture and the crown remains stable.
...
1. Conduct the trainer-controlled power-off/restart check only where spill and electrical controls are adequate.
...
1. Record final values and obtain trainer verification before draining.
...
1. Isolate power, drain through the approved route, remove residue, clean, rinse, dry, reassemble and store.
...
https://www.tertiarycourses.com.sg/wsq-basic-urban-farming-with-hydroponics.html

https://www.sfa.gov.sg/news-publications/newsroom/singapore-food-statistics-2025

https://www.mse.gov.sg/latest-news/oral-reply-to-parliamentary-question-on-revised-local-production-targets/

https://www.sfa.gov.sg/food-science-and-technology/technology/agriculture-technologies

https://www.sfa.gov.sg/fromSGtoSG/farms/farm/Detail/comcrop

https://www.sfa.gov.sg/fromSGtoSG/farms/farm/Detail/sustenir-agriculture
...
https://enterprise.nus.edu.sg/startup-story/singrow-2/

https://www.businesstimes.com.sg/singapore/smes/singapore-food-output-gets-s80-million-boost-opening-greenphytos-vertical-farm-tallest-world

https://www.rhs.org.uk/vegetables/hydroponics

https://extension.illinois.edu/blogs/good-growing/2026-01-16-growing-without-soil-getting-started-hydroponics-home

https://extension.unr.edu/publication.aspx?PubID=2756
